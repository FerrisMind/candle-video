//! FlowMatchEulerDiscreteScheduler — общий scheduler для LTX-Video и Wan.
//!
//! Портирован из diffusers Python implementation.
//! Поддерживает: dynamic shifting (SD3 style), karras/exponential/beta sigmas.
...
/// Specification for timesteps in scheduler.
#[derive(Debug, Clone)]
...
/// Extended scheduler config for dynamic shifting support.
#[derive(Debug, Clone)]
...
/// Extended scheduler trait with config and timestep management.
...
impl FlowMatchEulerDiscreteSchedulerConfig {
    /// Preset for LTX-Video 0.9.5+
    pub fn ltx_video() -> Self {
        Self::default()
    }

    /// Preset for Wan T2V (flow_shift=5.0 for 720p)
    ...
    /// Preset for Wan T2V (flow_shift=3.0 for 480p)
...
// =============================================================================
// FlowMatchEulerDiscreteScheduler Output
// =============================================================================
...
pub struct FlowMatchEulerDiscreteScheduler {
    ...
    // Cached SchedulerConfig for trait
